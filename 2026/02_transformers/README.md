### Lecture 2: Sequence Models, Attention, and Tranformers

#### Language and Sequence Modeling: Language Modeling Fundamentals
...
3. `recurrent_lm.ipynb`: recurrent language model
4. `recurrent_encdec.ipynb`: recurrent encoder-decoder with attention

#### Transformers

5. `transformer.ipynb`: transformer language model
